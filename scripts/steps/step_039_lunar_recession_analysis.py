...
def main():
    parser = argparse.ArgumentParser(description='Lunar Recession Analysis (Step 039)')
    ...
    log_file = log_dir / "step_039_lunar_recession_analysis.log"
    ...
    # Save output
    output_path = PROJECT_ROOT / "results/outputs/step_039_lunar_recession_analysis.json"

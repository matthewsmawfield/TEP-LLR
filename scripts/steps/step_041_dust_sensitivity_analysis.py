...
def main():
    parser = argparse.ArgumentParser(description='Dust Model Sensitivity Analysis (Step 041)')
    ...
    log_file = log_dir / "step_041_dust_sensitivity_analysis.log"
    logger = TEPLogger("step_041", str(log_file))
    ...
    # Save output
    output_path = PROJECT_ROOT / "results/outputs/step_041_dust_sensitivity_analysis.json"

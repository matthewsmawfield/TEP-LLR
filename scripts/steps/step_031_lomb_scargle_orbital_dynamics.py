...
def main():
    ...
    logger = TEPLogger(name="step_031", log_file_path=str(log_dir / "step_031_lomb_scargle_orbital_dynamics.log"))
    ...
    logger.save_step_results(output_data, PROJECT_ROOT, "step_031_lomb_scargle_orbital_dynamics")

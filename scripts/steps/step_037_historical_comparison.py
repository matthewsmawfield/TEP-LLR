...
def main():
    parser = argparse.ArgumentParser(description='Historical Comparison Analysis (Step 037)')
    ...
    log_file = log_dir / "step_037_historical_comparison.log"
    ...
    # Save output
    output_path = PROJECT_ROOT / "results/outputs/step_037_historical_comparison.json"

...
def main():
    ...
    logger = TEPLogger("step_027", str(log_dir / "step_027_leverage_temporal_clustering.log"))
    set_step_logger(logger)
    
    results = run_leverage_clustering(logger)
    
    # Save output to JSON
    output_path = PROJECT_ROOT / "results" / "outputs" / "step_027_leverage_temporal_clustering.json"

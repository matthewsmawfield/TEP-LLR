...
def main():
    ...
    logger = TEPLogger("step_018", str(log_dir / "step_018_leverage_diagnostics.log"))
    set_step_logger(logger)

    print_status("═══ Starting Step 018: Leverage Diagnostics Investigation...", "TITLE")
    ...
    print_status(f"    Output file: results/outputs/step_018_leverage_diagnostics.json", "INFO")
    ...
    logger.save_step_results(results, Path(__file__).parent.parent.parent, "step_018_leverage_diagnostics")
    logger.info(

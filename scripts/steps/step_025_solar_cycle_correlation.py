...
def run_solar_correlation(df, verbose=False):
    print_status("═══ Starting Step 025: Solar Cycle Correlation & Haleakala Station Anomaly...", "TITLE")
    ...
    print_status(f"    Output file: results/outputs/step_025_solar_cycle_correlation.json", "INFO")
...
if __name__ == "__main__":
    ...
    logger = TEPLogger("step_025", str(
        log_dir / "step_025_solar_cycle_correlation.log"))
    ...
    logger.save_step_results(results, PROJECT_ROOT,
                             "step_025_solar_cycle_correlation")

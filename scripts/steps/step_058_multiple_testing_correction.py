...
def main():
    ...
    print("=" * 70)
    print("Step 058: Formal Multiple Testing Correction")
    print("=" * 70)
    
    # Collect all reported significance values
    tests = collect_reported_significance_values()
    
    print(f"\nCollected {len(tests)} significance tests from the analysis pipeline")
    ...
    print(f"  Still significant after BH: {bh_rejected[primary_idx]}")
    ...
    # Save results
    output_path = 'results/outputs/step_058_multiple_testing_correction.json'
    with open(output_path, 'w') as f:
        json.dump(results, f, indent=2)
    print(f"\nResults saved to {output_path}")
    
    print("\n" + "=" * 70)
    print("Step 058 completed successfully")
    print("=" * 70)

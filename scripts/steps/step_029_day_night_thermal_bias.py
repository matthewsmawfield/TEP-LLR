...
def main():
    ...
    logger = TEPLogger("step_029", str(log_dir / "step_029_day_night_thermal_bias.log"))
    ...
    logger.save_step_results(output_data, PROJECT_ROOT, "step_029_day_night_thermal_bias")

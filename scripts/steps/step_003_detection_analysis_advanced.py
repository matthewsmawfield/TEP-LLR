...
def setup_tep_logger(verbose: bool = False) -> TEPLogger:
    ...
    log_file = log_dir / "step_003_detection_analysis_advanced.log"
    logger = TEPLogger("step_003", str(log_file))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Step 003: Advanced TEP Detection Analysis")
    ...
    print_status("═══ Starting Step 003: Advanced TEP Detection Analysis...", "TITLE")
    ...
    print_status(f"    Output file: results/outputs/step_003_detection_analysis_advanced.json", "INFO")
    ...
    # Save results
    output_path = PROJECT_ROOT / "results" / "outputs" / "step_003_detection_analysis_advanced.json"

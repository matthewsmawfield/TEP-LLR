...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Step 004: Temporal Drift Analysis with Autocorrelation")
    args = parser.parse_args()

    log_dir = PROJECT_ROOT / "logs"
    logger = TEPLogger("step_004", str(
        log_dir / "step_004_temporal_drift_analysis.log"))
    ...
    logger.save_step_results(results, PROJECT_ROOT,
                             "step_004_temporal_drift_analysis")

...
if __name__ == "__main__":
    ...
    logger = TEPLogger("step_036", str(log_dir / "step_036_static_dynamic_absorption.log"))
    set_step_logger(logger)
    
    results = run_absorption_comparison()
    
    if results:
        logger.save_step_results(results, PROJECT_ROOT, "step_036_static_dynamic_absorption")

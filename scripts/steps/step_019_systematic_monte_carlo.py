...
def main():
    ...
    logger.info("Step 019: Systematic Error Monte Carlo Propagation")
    ...
    results = monte_carlo_systematic_analysis(df, n_mc=500, seed=42, logger=logger)

    # Add metadata
    results['step_id'] = 'step_019'
    results['status'] = 'PASS'
    ...
    output_path = project_root / 'results' / 'outputs' / 'step_019_systematic_monte_carlo.json'

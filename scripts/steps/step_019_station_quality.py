...
def main():
    ...
    logger = TEPLogger("step_019", str(log_dir / "step_019_station_quality.log"))
    set_step_logger(logger)

    print_status("═══ Starting Step 019: Station Quality Diagnostics...", "TITLE")
    ...
    logger.info("Step 019: Station Quality Diagnostics")
    ...
    print_status(f"    Output file: results/outputs/step_019_station_quality.json", "INFO")
    ...
    logger.save_step_results(results, Path(__file__).parent.parent.parent, "step_019_station_quality")

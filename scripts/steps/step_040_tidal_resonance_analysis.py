...
def main():
    parser = argparse.ArgumentParser(description='Tidal Resonance Analysis (Step 040)')
    ...
    log_file = log_dir / "step_040_tidal_resonance_analysis.log"
    logger = TEPLogger("step_040", str(log_file))
    ...
    # Save output
    output_path = PROJECT_ROOT / "results/outputs/step_040_tidal_resonance_analysis.json"

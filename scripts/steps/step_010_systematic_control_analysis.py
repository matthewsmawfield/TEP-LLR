...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Step 010: Systematic Control Analysis")
    args = parser.parse_args()

    log_dir = PROJECT_ROOT / "logs"
    logger = TEPLogger("step_010", str(log_dir / "step_010_systematic_control_analysis.log"))
    ...
    logger.save_step_results(results, PROJECT_ROOT,
                             "step_010_systematic_control_analysis")
